...
Plot the outcome of one_fit.py, with movie.
...
class VideoPlayerWidget(QWidget):
    def __init__(self):
        ...
        for _row in self.behaviour_rows.itertuples():
            ...
            # CHANGED: rename 'loiter' -> 'notmuch' only for legend display
            display_label = "notmuch" if str(_row.label) == "loiter" else str(_row.label)
            lab = QLabel(display_label)
