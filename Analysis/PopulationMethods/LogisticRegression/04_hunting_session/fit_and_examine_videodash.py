...
Plot the outcome of fit_and_examine.py, with movie.
...
print(f"Loading fit data from {fit_load_path}")
...
best10_df = fit_data['best10_units_per_behaviour']
...
# manually, for now
important_neurons = best10_df.unit.unique()
...
#%%
last_train_time_per_label_df=fit_data['last_train_time_per_label']
