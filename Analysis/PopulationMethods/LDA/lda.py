...
#%%Calculation of instantaneous firing rates

#indexiing PAG neurons
...
binned_firing_rates, mean_rates, binned_ifr,  mean_rates_ifr, time_bins, recast_spike_times = mean_firing_rate(spike_times, firing_rates, stop_time=n_time_index[-1], bin_size_ms=100) #whole session
...
X_raw, selected_clusters = export_design_matrix(
    binned_firing_rates, n_region_index, time_bins, n_cluster_index,
