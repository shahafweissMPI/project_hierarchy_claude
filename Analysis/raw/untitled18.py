...
target_regions=['DMPAG','DLPAG','LPAG'] # From which regions should the neurons be?
...
for chunk in range(num_chunks):
    ...
    # Set figure size to full screen (e.g., 1920x1080 pixels)
    ...
    plt.savefig(rf"E:\test\{n_region_index[n]}_{b_name}_{chunk}.png", bbox_inches='tight')
    plt.close(fig)
