...
def cut_rawData2vframes(paths, frame_channel_index=0):
    """
...
def extract_sleap(path, vpath, node, vframerate):
    """
    ...
    dist=hf.euclidean_distance(locations, mean_loc[:,None,:], axis=2)
