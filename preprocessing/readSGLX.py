# -*- coding: utf-8 -*-
"""
Created on Fri May  9 08:47:31 2025
...
def readMeta(binFullPath):
    ...
    metaName =Path(binFullPath).stem + ".meta"
...
def ExtractDigital(rawData, firstSamp, lastSamp, dwReq, dLineList, meta):
    ...
    if len(selectData)==0:
        ...
        raise ValueError(f"{digCh=} resulted in empty selectData ")
...
def main():
    ...
    # Windows specific; forces the window to appear in fronts
